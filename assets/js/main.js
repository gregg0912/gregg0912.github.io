...
function toggleSkills() {
  ...
  skillsContent.forEach((content) => content.className = 'skills__content skills__close');
...
if (selectedTheme) {
  ...
  portfolioContent.forEach(content => content.classList[selectedTheme === 'dark' ? 'add' : 'remove'](darkTheme));
  themeButton.classList[selectedIcon === 'uil-moon' ? 'add' : 'remove'](iconTheme);
}

themeButton.addEventListener('click', () => {
  document.body.classList.toggle(darkTheme);
  portfolioContent.forEach(content => content.classList.toggle(darkTheme));
